...
sudo apt-get -y install gcc make ncurses-dev libxml2-dev gnutls-bin gnutls-dev libpng-dev libacl1-dev build-essential mailutils libgccjit-14-dev texinfo pkg-config libgnutls28-dev libgtk-3-dev libtree-sitter-dev
